  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        <h1 className="font-headline text-xl font-bold text-slate-900">Workforce Reports &amp; Exports</h1>
      ...
      {downloadMsg && (
        <div className="p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl text-xs sm:text-sm flex items-center space-x-2 shadow-sm animate-fadeIn font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {reports.map((r) => {
          const Icon = r.icon;
          return (
            <div key={r.id} className="bg-white p-6 rounded-2xl border border-slate-200 space-y-5 flex flex-col justify-between shadow-sm hover:border-blue-500/40 transition-all">
              <div className="space-y-3">
                ...
                <div>
                  <h2 className="font-headline text-base font-bold text-slate-900">{r.title}</h2>
              ...
              <button
                ...
                className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl text-xs transition flex items-center justify-center space-x-2 shadow-sm"
              >
