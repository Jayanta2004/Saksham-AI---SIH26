  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4 py-12">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        ...
        {error && (
          <p className="text-xs text-red-600 mb-4 text-center bg-red-50 py-2 px-3 rounded-lg border border-red-100 font-medium">
            {error}
          </p>
        )}
        ...
        {step === 3 && (
          <div className="text-center space-y-4 py-2">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900">Your password has been reset</p>
