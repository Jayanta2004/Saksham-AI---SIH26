...
export default function Header({ onMenuToggle }) {
  ...
  return (
    <header className="h-14 bg-white border-b border-slate-200 px-4 md:px-6 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-3 min-w-0">
        {onMenuToggle && (
          <button
            ...
            className="p-1.5 -ml-1.5 text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-lg md:hidden transition-colors"
      ...
      {/* Right: Notifications, Avatar Circle, Logout */}
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-slate-200">
          <div
            className="w-8 h-8 rounded-full bg-blue-50 text-blue-600 border border-blue-200 font-semibold text-xs flex items-center justify-center shrink-0"
            title={displayName}
          >
            {initial}
          </div>
